...
import static com.lyft.data.gateway.ha.router.RoutingGroupSelector.PRESTO_ROUTING_GROUP_HEADER;
...
public class TestRoutingGroupSelector {
  public void testByRoutingGroupHeader() {
    ...
    when(mockRequest.getHeader(PRESTO_ROUTING_GROUP_HEADER)).thenReturn("batch_backend");
    Assert.assertEquals(
    ...
    when(mockRequest.getHeader(PRESTO_ROUTING_GROUP_HEADER)).thenReturn(null);
